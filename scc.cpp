...
void Dfs1(std::vector<int> *v,int st,bool *visited)
{ 
		visited[st] = true;
     // s.pop(); 
     	cout<<st<<" ";
...
int main() {
  ...
  FOR(i,0,n){
   ...
   // topo1(v,q);
    std::vector<int> *v1 = new vector<int>[n];
...
//   {
//     cout<<i<<" ";
//     for (std::vector<int>::iterator j = v1[i].begin(); j != v1[i].end(); j++)
//     {
//       cout<<*j<<" ";
//     }
//     cout<<endl;
//   }
    ...
    {
    	//cout<<la.top()<<" ";
    	if (visited[la.top()]==false)
    	{
    	   Dfs1(v1,la.top(),visited);
